...
@Service
public class LoginStudentService implements UserDetailsService  {

	@Autowired
	private LoginStudentService loginService;
	...
	public LoginStudentResponse authenticate(LoginRequest loginRequest) throws Exception {
		authenticate(loginRequest.getUsername(), loginRequest.getPassword());
		final UserDetails userDetails = loginService.loadUserByUsername(loginRequest.getUsername());
		Role role = new Role();
		role.setId(loginRequest.getRole().getId());
		role.setName(loginRequest.getRole().getName());
		final String token = jwtTokenUtil.generateToken(userDetails,role);
		LoginStudentResponse loginResponse = new LoginStudentResponse();
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		StudentModel model = studentService.getByUsername(username);
