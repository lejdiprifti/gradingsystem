...
public class LoginTeacherService {
	...
	@Autowired
	private LoginTeacherService loginService;
	...
	public LoginTeacherResponse authenticate(LoginRequest loginRequest) throws Exception {
		...
		LoginTeacherResponse loginResponse = new LoginTeacherResponse();
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		TeacherModel model = teacherService.getByUsername(username);
